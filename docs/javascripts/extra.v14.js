/* v14 — força Sair à direita, busca central fixa e dropdown sobre o menu */
(function(){
  const VER = 'v14';
  console.log('DG extra.js', VER);
  ...
  function injectLogout(){
    ...
    Object.assign(a.style,{
      marginLeft:'16px', marginRight:'40px', padding:'10px 28px',
      border:'none', borderRadius:'6px', background:'#D40511', color:'#fff',
      fontWeight:'700', fontSize:'15px', lineHeight:'1.3', cursor:'pointer',
  ...
  function hideGitHubLink(){
    document.querySelectorAll('.md-header__source').forEach(e=>e.style.display='none');
  }
  ...
  /* ===== Dropdown da busca (usa componente do Material, sem overlay) ===== */
...
> Natália:
querySelector('input[data-md-component="search-query"]') || root.querySelector('input[type="text"]');
  ...
  function run(){ injectLogout(); hideGitHubLink(); injectTopNavMega(); wireSearchDropdown(); }
