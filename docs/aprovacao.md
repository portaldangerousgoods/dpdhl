# Como aprovar sua conta para envio de Mercadorias Perigosas

Se você deseja enviar **Mercadorias Perigosas (DG)** com a DHL Express, é necessário passar por um processo de **aprovação de conta**. Esse procedimento garante que sua empresa esteja em conformidade com as normas da **IATA (Associação Internacional de Transporte Aéreo)** e com as políticas internas da DHL Express.
...
<p align="center">
  <img src="certificado.png" alt="Certificado DG IATA" style="width:60%; border-radius:8px;">
</p>
...
## Validação de rota — obrigatório!

> ⚠️ **Atenção:** nem toda origem e destino estão autorizados a enviar Mercadorias Perigosas.  
> Antes de solicitar a aprovação da conta, é necessário validar se a **rota é permitida** para o tipo de mercadoria DG em questão.

Entre em contato com seu responsável comercial DHL para confirmar se o **país de origem e o país de destino** estão habilitados para o envio da sua mercadoria perigosa.

Essa verificação evita recusas, atrasos e garante total conformidade com as exigências internacionais.
